...
import { DataTablePagination } from "@/components/Tabla/data-table-pagination"
...
export function DataTable<TData, TValue>({
  ...
  const [pagination, setPagination] = React.useState({
    pageIndex: 0,
    pageSize: cantidadRegistrosPorPagina, // Valor inicial
  });
  ...
  return (
    <div className="space-y-4">
      ...
      <DataTablePagination
        table={table}
        mostrarFilasSeleccionadas={mostrarFilasSeleccionadas}
        mostrarCantidadDeFilasPorPagina={mostrarCantidadDeFilasPorPagina}
